...
|---|---|---|---|---|
| `runs_improved_grouped` | **0.8333** | 0.0135 | grouped by PEPTIDE | held-out peptides; hard negatives are same-target different-family |
| `runs_ctrft_fold*` | **0.8248** | 0.0130 | grouped by PEPTIDE | route C contrastive encoder, same protocol as baseline |
| `runs_improved` | **0.8145** | 0.0194 | stratified (LEAKY) | reference only - a peptide can appear in train and test |
| `runs_family` | **0.8142** | 0.0477 | family-grouped (STRICTEST) | held-out FAMILIES; 219/352 positives sit in multi-member families |
| `runs_xneg` | **0.7940** | 0.0196 | grouped by PEPTIDE | specificity training (rejected) |
| `runs_s2` | **0.7539** | 0.0107 | grouped by PEPTIDE | Propedia cross-topology transfer |
| `runs_prop` | **0.7481** | 0.0565 | family-grouped | route A label propagation (rejected) |
| `runs_reg_cls` | **0.6430** | 0.0226 | by TARGET | affinity classification A+C; new targets |
| `runs_warmup` | **0.6391** | 0.0188 | grouped by PEPTIDE | S1 curriculum warmup stage |
